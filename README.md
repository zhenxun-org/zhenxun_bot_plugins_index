...
|                             名称                             |                         作者                         |                             备注                             |
| :----------------------------------------------------------: | :--------------------------------------------------: | :----------------------------------------------------------: |
| [原神角色卡片](https://github.com/CRAZYShimakaze/zhenxun_extensive_plugin/tree/main/genshin_role_card) | [@CRAZYShimakaze](https://github.com/CRAZYShimakaze) | 参考自 [zhenxun-plugin-almanac](https://github.com/zhenxun-org/zhenxun_bot-tg/tree/main/plugins/genshin/almanac)，展示橱窗中第一个角色的面板数据 |
| [头像表情包](https://github.com/yajiwa/zhenxun_plugin_petpet)  [点击下载](https://github.com/yajiwa/zhenxun_plugin_petpet/releases/download/v0.3/zhenxun_plugin_petpet.zip) |         [@yajiwa](https://github.com/yajiwa)         |                     制作头像相关的表情包                     |
